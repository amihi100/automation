...
public class Monday2 {
	 ...
	 String pangoURL, panguGUID, carNumber, screenShotPath, filename, userName, lastName, idDriver, birthDate,
	 ...
	 int waitForElement, waitBeforeClick;
	...
	public  void defineVariables() throws InterruptedException, IOException {
		try {
	...
	public  void initialOffer() throws InterruptedException, IOException {
		try {
	...
	public  void initialOfferScreen() throws InterruptedException, IOException {
	...
	public  void finalOffer() throws InterruptedException, IOException {
	...
	public  void finalOfferScreen() throws InterruptedException, IOException {
		try {
			// Screen: Final offer!
			...
			System.out.println("Failed in FINAL OFFER screen");
			return;
		}
	}
	public  void covers() throws InterruptedException, IOException{
		try {
			// Screen: Covers.
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
			...
			System.out.println("Failed in COVERS screen");
			return;
		}
	}
	public  void payments() throws InterruptedException, IOException {
		...
		try {
			...
			System.out.println("Failed in PAYMENTS screen");
			return;
		}
	}

	public  void creditGuard() throws InterruptedException, IOException {
		// Screen: CreditGuard
		try {
