...
public class OldDevSanityAllOptions {
	 ...
	 String environmentURL, devURL, stageURL, panguGUID, carNumber, screenShotPath, filename, insuredName,
			...
			email, cellphone, contactCellphone, driver1Name, cardNumber, driver1LastName, driver1Id, driver1BirthDate, cardPersonalId,
			driver1LicenseIssueYear, cardFullName, cardMonth, cardYear;
	 ...
	 * date.add(Calendar.DATE, 1); Or just assign the Vars to specific date: 
	 * int startDateYear = 2019;  int startDateMonth = 2;  int
	 * startDateDay = 19;
	 */
	// Start insurance at the same day.
	 int startDateYear = Calendar.getInstance().get(Calendar.YEAR);
	//  int startDateMonth = Calendar.getInstance().get(Calendar.MONTH)+9;
	...
	/**
	 * Screen 1.5 Mortgaged car. Mortgaged NO:  String mortgagedCar =
	 ...
	 * Mortgaged YES:  String mortgagedCar =
	...
	/**
	 * Screen 1.6: 3 years insurance. Yes 3 years insurance:  String
	 * threeYearsInsurance =
	 ...
	 * No 3 years ins  String threeYearsInsurance =
	...
	/**
	 * Screen 1.7: Claims in 3 years. No claims in 3 years:  String
	 * claimsIn3Years =
	 ...
	 * Yes claims in 3 years:  String claimsIn3Years =
	...
	// No claims in 3 years:
	 String claimsIn3Years = "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[7]/div/app-step-content-horizontal-options-view/ul/li[1]/label/span[1]";

	public  void defineVariables() throws Exception {
		try {
			...
			carNumber = "5901079"; // Menora car#: 59XXX79.
			insuredName = "עמיחי";
			...
			//environmentURL = "https://stage.pango-ins.co.il/api/test/url?uid=7ee1878d-556c-4aef-ab25-2e29cbae93d8&ln=" + carNumber;
			// DEV Environment:
	...
	public  void initialOffer() throws Exception {
		try {
	...
	public  void initialOfferScreen() throws Exception {
		...
		try {
			...
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/input").sendKeys(contactCellphone);
	...
	public  void payments() throws Exception {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(waitBeforeClick);
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/div/p/span").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"modal-pay-insurance\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[1]/div/span[1]").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"modal-payments\"]/div[1]/div/div[2]/app-step-content-vertical-options-view/ul/li[2]/label").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[1]/div/span[1]").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"modal-payments\"]/div[1]/div/div[2]/app-step-content-vertical-options-view/ul/li[3]/label").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[1]/div/span[1]").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"modal-payments\"]/div[1]/div/div[2]/app-step-content-vertical-options-view/ul/li[4]/label").click();
			TimeUnit.SECONDS.sleep(10);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[2]/app-step-content-horizontal-options-view/ul/li[2]/label/span[1]")));
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[1]/div/span[1]").click();
			driver.findElementByXPath("//*[@id=\"modal-payments\"]/div[1]/div/div[2]/app-step-content-vertical-options-view/ul/li[9]/label").click();
			TimeUnit.SECONDS.sleep(10);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[2]/app-step-content-horizontal-options-view/ul/li[2]/label/span[1]")));
			//Go back to Final offer:
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/div/button").click();
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[1]/div/div[2]/div/button[2]").click();
			// Go forward to covers:
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("/html/body/app-root/final-bid/div/div[1]/a").click();
			//Remove cover:
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[1]/div/div[2]/horizontal-checkboxes/ul/li[1]/label").click();
			TimeUnit.SECONDS.sleep(10);
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[1]/div/div[2]/div/button[1]")));
			driver.findElementByXPath("/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[1]/div/div[2]/div/button[1]").click();
			TimeUnit.SECONDS.sleep(waitBeforeClick);
	...
	public  void creditGuard() throws Exception {
		// Screen: CreditGuard
		try {
			TimeUnit.SECONDS.sleep(10);
	...
	public void pangoAutomatedTest() throws InterruptedException, IOException {
		try {
			defineVariables();
			initialOffer();
			initialOfferScreen();
