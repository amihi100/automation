...
public class DevSanityAll {
	 ...
	 * All drivers: static String howManyDrivers =
	 * "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[2]/div/app-step-content-vertical-options-view/ul/li[4]/label";
	 */
	// 1 driver:
	static String howManyDrivers = "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[2]/div/app-step-content-vertical-options-view/ul/li[4]/label";
	 ...
	 */
	// Female:
	static String gender = "/html/body/app-root/external-app-offer/aw-wizard/div/aw-wizard-step[1]/div/ul/li[1]/question-wrapper/div/div/app-step-content-horizontal-options-view/ul/li[2]/label/span[1]";
...
/**
	...
	public static void finalOffer() throws Exception {
		...
		try {
			...
			driver.findElementByXPath(
					...
					.click();
			TimeUnit.MILLISECONDS.sleep(500);
			driver.findElementByXPath(gender).click();
			TimeUnit.MILLISECONDS.sleep(500);
			driver.findElementByXPath(
	...
	public static void finalOfferScreen() throws Exception {
		try {
			...
			driver.findElementByXPath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/input").clear();
			TimeUnit.SECONDS.sleep(1);

			driver.findElementByXPath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/a").click();
			TimeUnit.SECONDS.sleep(1);
			driver.findElementByXPath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/input")
					.sendKeys(contactCellphone1);
			TimeUnit.SECONDS.sleep(1);
			wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/button")));
			driver.findElementByCssSelector("#modal-call-back > div.modal-dialog > div > div.modal-body > p > button")
	...
	public static void main(String[] args) throws IOException, InterruptedException {
		...
		//Decoration
	//	@Parameters({"env","carNumber"})
		
	//	public DevSanityAllOptions(String env,String carNumber) throws InvalidPropertiesFormatException, FileNotFoundException, IOException {
