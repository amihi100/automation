...
public class sanityAllOptions{
	...
	@Parameters("env")
	public sanityAllOptions(String env) throws InvalidPropertiesFormatException, FileNotFoundException, IOException, InterruptedException {
...
;
	...
	/**
	 ...
	 oneDriver = "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[2]/div/app-step-content-vertical-options-view/ul/li[1]/label";
	 twoDrivers = "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[2]/div/app-step-content-vertical-options-view/ul/li[2]/label";
	 threeDrivers = "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[2]/div/app-step-content-vertical-options-view/ul/li[3]/label";
	 allDrivers = "/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[2]/div/app-step-content-vertical-options-view/ul/li[4]/label";
	**/
...
//			 Now copy .jpeg to screenShotPath
			...
			TimeUnit.SECONDS.sleep(	VarClass.waitBeforeClick);
			VarClass.driver.findElementByXPath("/html/body/app-root/app-offer/aw-wizard/div/aw-wizard-step[3]/button").click();
	...
	public void initialOfferScreen() throws Exception {
		try {
			...
			VarClass.driver.findElementByXPath("//*[@id=\"modal-insurance-covers\"]/div[1]/div/div[2]/ul/li[1]/panel/div/div[1]")
					.click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-insurance-covers\"]/div[1]/div/div[2]/ul/li[1]/panel/div/div[1]")
					.click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-insurance-covers\"]/div[1]/div/div[2]/ul/li[3]/panel/div/div[1]")
					.click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-insurance-covers\"]/div[1]/div/div[2]/ul/li[3]/panel/div/div[1]")
					.click();
			...
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("/html/body/app-root/primary-bid/div/div[1]/ul/li[2]/a").click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-shield\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("/html/body/app-root/primary-bid/div/div[1]/div[9]/a[1]").click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-terms-of-service\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("/html/body/app-root/primary-bid/div/div[1]/div[9]/a[2]").click();
			TimeUnit.MILLISECONDS.sleep( this.VarClass.MILLISECONDS);
...
/*				
			...
			VarClass.driver.findElementByCssSelector("#modal-call-back > div.modal-dialog > div > div.modal-body > p > button")
					.click();
			TimeUnit.MILLISECONDS.sleep(VarClass.MILLISECONDS);
			...
			TimeUnit.SECONDS.sleep(VarClass.waitBeforeClick);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-call-back-success\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.SECONDS.sleep(VarClass.waitBeforeClick);
	...
	public void finalOfferQuestions() throws Exception {
		...
		try {
			...
			VarClass.driver.findElementByXPath("//*[@id=\"step-2-lastName-1\"]").sendKeys( this.VarClass.insuredLastName);
			VarClass.driver.findElementByXPath("//*[@id=\"step-2-personalId-2\"]").sendKeys( this.VarClass.insuredIdDriver);
			// birthDate
			TimeUnit.SECONDS.sleep(1);
			// stepTwoBirthPicker
			JavascriptExecutor js = (JavascriptExecutor) VarClass.driver;
			js.executeScript(
					"window.stepTwoBirthPicker.setSelectedDate(new Date(" +  this.VarClass.insuredBirthDate + ", 1, 0, 0, 0, 0, 0))");
			TimeUnit.SECONDS.sleep(1);
			...
			// licenseIssueYear
			TimeUnit.SECONDS.sleep(1);
			js.executeScript("window.stepTwoLicensePicker.setSelectedDate(new Date(" +  this.VarClass.insuredLicenseIssueYear
					+ ", 6, 14, 0, 0, 0, 0))");
			TimeUnit.SECONDS.sleep(1);
			...
			TimeUnit.SECONDS.sleep(1);
			VarClass.driver.findElementByXPath("//*[@id=\"step-3-cityID-0\"]/div/div/div[2]/input").sendKeys( this.VarClass.city);
			TimeUnit.SECONDS.sleep(1);
			VarClass.driver.findElement(By.cssSelector("div.ng-dropdown-panel-items>div>div.ng-option")).click();
			TimeUnit.SECONDS.sleep(1);
			VarClass.driver.findElementByXPath("//*[@id=\"step-3-streetID-1\"]/div/div/div[2]/input").sendKeys( this.VarClass.street);
			TimeUnit.SECONDS.sleep(1);
			VarClass.driver.findElement(By.cssSelector("div.ng-dropdown-panel-items.scroll-host>div>div.ng-option")).click();
	...
	public void finalOfferScreen() throws Exception {
		try {
			...
			VarClass.driver.findElementByXPath(
					"//*[@id=\"modal-insurance-covers-2\"]/div[1]/div/div[2]/ul/li[3]/panel/div/div[1]").click();
			VarClass.driver.findElementByXPath("//*[@id=\"modal-insurance-covers-2\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.MILLISECONDS.sleep(this.VarClass.MILLISECONDS);
			VarClass.	driver.findElementByXPath("/html/body/app-root/final-bid/div/div[1]/div[6]/a[2]").click();
			TimeUnit.MILLISECONDS.sleep(this.VarClass.MILLISECONDS);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-insurance-takanon\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.MILLISECONDS.sleep(this.VarClass.MILLISECONDS);
		} catch (Exception e) {
	...
	public void callMeWizard2() throws Exception {
		try {
			...
			TimeUnit.SECONDS.sleep(1);
			VarClass.driver.findElementByXPath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/input")
					.sendKeys(this.VarClass.wizardPhone1);
			TimeUnit.SECONDS.sleep(1);
			this.VarClass.wait.until(ExpectedConditions
					.visibilityOfElementLocated(By.xpath("//*[@id=\"modal-call-back\"]/div[1]/div/div[2]/p/button")));
			VarClass.driver.findElementByCssSelector("#modal-call-back > div.modal-dialog > div > div.modal-body > p > button")
	...
	public void iframeCreditGuard() throws Exception {
		...
		try {
			...
			if(VarClass.appID) {
				...
				this.VarClass.wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id=\"submitBtn\"]/span")));
				TimeUnit.SECONDS.sleep(1);
	...
	public void thankYouPage() throws Exception {
		try {
			...
			if (URL == this.VarClass.thankYouURL || this.VarClass.wait
