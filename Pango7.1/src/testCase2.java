...
public class testCase2 {
	...
	public static void defineVariables() throws InterruptedException, IOException {
		try {
	...
	public static void initialOffer() throws InterruptedException, IOException {
		try {
	...
	public static void initialOfferScreen() throws InterruptedException, IOException {
	...
	public static void finalOffer() throws InterruptedException, IOException {
	...
	public static void finalOfferScreen() throws InterruptedException, IOException {
		try {
			// Screen: Final offer!
	...
	public static void covers() throws InterruptedException, IOException {
		try {
			// Screen: Covers.
			wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
	...
	public static void payments() throws InterruptedException, IOException {
	...
	public static void creditGuard() throws InterruptedException, IOException {
		// Screen: CreditGuard
		try {
