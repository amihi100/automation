...
public class sanityPangoCC {
	 ...
	 */
	static String youngestDriverAge = "32";
	...
	public static void defineVariables() throws Exception {
		try {
			...
			carNumber = "5903479"; // Menora car#: 59XXX79.//5901079
			insuredName = "עמיחי";
			...
			// STAGE Environment:
			environmentURL = "https://stage.pango-ins.co.il/api/test/url?uid=6ad283b3-58cb-4cbf-a1b0-d4c1c1ceffc3&ln="
					+ carNumber;
			// environmentURL =
	...
	public static void payments() throws Exception {
		...
		try {
			...
			//wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				//	"/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[2]/app-step-content-horizontal-options-view/ul/li[2]/label/span[2]/img[1]")));

			TimeUnit.SECONDS.sleep(waitBeforeClick);
			driver.findElementByXPath(
					"/html/body/app-root/offer-payment/aw-wizard/div/aw-wizard-step[2]/div/div[2]/ul/li[2]/app-step-content-horizontal-options-view/ul/li[1]/label/span[2]/img[1]")
					.click();
		} catch (Exception e) {
	...
	/**
	 * public static void creditGuard() throws Exception { // Screen: CreditGuard
	 * try { TimeUnit.SECONDS.sleep(10); driver.switchTo().frame(0);
	 ...
	 * TimeUnit.SECONDS.sleep(1); // driver.switchTo().defaultContent(); Select
	 * dropdownYear = new Select(driver.findElement(By.id("expYear")));
	 * dropdownYear.selectByVisibleText(cardYear); TimeUnit.SECONDS.sleep(1); Select
	 * dropdownMonth = new Select(driver.findElement(By.id("expMonth")));
	 * TimeUnit.SECONDS.sleep(1); dropdownMonth.selectByVisibleText(cardMonth);
	 * TimeUnit.SECONDS.sleep(waitBeforeClick);
	 * driver.findElementByXPath("//*[@id=\"submitBtn\"]").click(); } catch
	 * (Exception e) { throw new Exception("Failed in Iframe CreditGuard"); } }
	 **/
	public static void pangoCredit() throws Exception {
		...
		//	System.out.println("number of iframes: "+iframe_element.size());
			...
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"mat-input-0\"]").sendKeys("עמיחי תורגמן");
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);
			driver.findElementByXPath("//*[@id=\"mat-input-1\"]").sendKeys("035871110");
			TimeUnit.MILLISECONDS.sleep(MILLISECONDS);

			driver.findElementByXPath("//*[@id=\"mat-checkbox-1\"]/label/div").click();
			TimeUnit.SECONDS.sleep(waitBeforeClick);
			driver.findElementByXPath("//*[@id=\"content\"]/form/button/span").click();
			System.out.println("Well Done!!!");
			

			
			/**
			driver.findElementByXPath("//*[@id=\"mat-select-0\"]/div/div[1]").click();
			...
			//driver.findElementByXPath("//*[@id=\"mat-input-0\"]").sendKeys("עמיחי");
			driver.findElement(By.xpath("//*[@id=\"mat-input-0\"]")).sendKeys("testing"); 
