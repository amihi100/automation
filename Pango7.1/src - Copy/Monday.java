...
public class Monday {
	...
	/*
	 * Screen 1.9 Restriction in 3 years No restrictions:  String restrictions
	 * =
	 ...
	 * Yes restrictions:  String restrictions =
	...
	public  void defineVariables() throws Exception {
		try {
			...
			// STAGE Environment:
			// environmentURL = "https://stage.pango-ins.co.il/api/test/url?ln=" +
			// carNumber;
			// environmentURL =
	...
	public  void initialOfferScreen() throws Exception {
		...
		try {
			...
			TimeUnit.SECONDS.sleep(waitBeforeClick);
			driver.findElementByXPath("/html/body/app-root/primary-bid/div/div[1]/a[2]").click();
	...
	public  void finalOfferScreen() throws Exception {
		try {
			...
			driver.findElementByXPath("//*[@id=\"modal-call-back-success\"]/div[1]/div/div[1]/button/img").click();
			TimeUnit.SECONDS.sleep(waitBeforeClick);
			driver.findElementByXPath("/html/body/app-root/final-bid/div/div[1]/a[2]").click();
		} catch (Exception e) {
	 ...
	 * InterruptedException { // TODO: Define variables and path before run on
	 * different machine System.out.println("Automated testing started!");
	 * 
	 * 
	 * pangoAutomatedTest(); System.out.println("Automated testing DONE!"); }
	 */
}